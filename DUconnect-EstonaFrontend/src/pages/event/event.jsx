...
const EventPage = () => {
    ...
    const defaultEvents = [
        { id: 1, title: 'Code Samurai', media: 'https://i.ibb.co/KVjnwHT/code.png', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et felis justo.', date: '2024-05-15' },
        { id: 2, title: 'CCharity for Cancer', media: 'https://i.ibb.co/Qkzpgns/charity.jpg', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et felis justo.', date: '2024-05-20' },
        { id: 3, title: 'DUBS Concert ', media: 'https://i.ibb.co/q5cqrDv/pexels-vishnurnair-1105666.jpg', description: 'Join us for an unforgettable night of music and celebration at the annual DUBS Summer Concert! ', date: '2024-05-25' },
        { id: 4, title: 'Save DU 4', media: 'https://i.ibb.co/N7VXdxV/save.jpg', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et felis justo.', date: '2024-05-30' },
    ];
        ...
        fetch("http://127.0.0.1:8003/get-events/", {
            ...
            .then((data) => {
              console.log("mhd mahmud anik");
               ...
               const combinedEvents = [...defaultEvents, ...data];
